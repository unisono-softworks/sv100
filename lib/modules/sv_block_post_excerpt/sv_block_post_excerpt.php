<?php
	...
	class sv_block_post_excerpt extends init {
		public function init() {
			$this->set_module_title( __( 'Block: Post Excerpt', 'sv100' ) )
				...
				->set_block_handle('wp-block-post-excerpt')
				->set_block_name('core/post-excerpt')
				->get_root()
				->add_section( $this );
		}
		
		public function load_settings(): sv_block_post_excerpt {
