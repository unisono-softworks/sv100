<?php
	...
	class sv_block_site_logo extends init {
		public function init() {
			$this->set_module_title( __( 'Block: Site Logo', 'sv100' ) )
				...
				->set_block_handle('wp-block-site-logo')
				->set_block_name('core/site-logo')
				->get_root()
				->add_section( $this );
		}
		
		protected function load_settings(): sv_block_site_logo {
