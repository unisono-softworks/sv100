<?php
	...
	class sv_block_post_featured_image extends init {
		public function init() {
			$this->set_module_title( __( 'Block: Featured Image', 'sv100' ) )
				...
				->set_block_handle('wp-block-post-featured-image')
				->set_block_name('core/post-featured-image')
				->get_root()
				->add_section( $this );
		}
		
		public function load_settings(): sv_block_post_featured_image {
