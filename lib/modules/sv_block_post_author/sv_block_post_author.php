<?php
	...
	class sv_block_post_author extends init {
		public function init() {
			$this->set_module_title( __( 'Block: Post Author', 'sv100' ) )
				...
				->set_block_handle('wp-block-post-author')
				->set_block_name('core/post-author')
				->get_root()
				->add_section( $this );
		}
		
		protected function load_settings(): sv_block_post_author {
